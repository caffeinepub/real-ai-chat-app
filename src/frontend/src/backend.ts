...
export class Backend implements backendInterface {
    ...
    async getCurrentConversationId(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getCurrentConversationId();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async listConversations(): Promise<Array<[bigint, string]>> {
        if (this.processError) {
            try {
    ...
    async switchConversation(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.switchConversation(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
